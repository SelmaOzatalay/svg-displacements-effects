...
export default function DisplacementLinear2({allAnimationsRunning}) {
    ...
    <div className="displacement" ref={wrapperRef}>
      ...
      <div className="displacement-img">
        <svg viewBox="0 0 768 768" ref={svgRef}>
          <defs>
            <linearGradient id="rainbowgradientLinear2" cx="683" cy="384" fx="683" fy="384" r="800.05" gradientUnits="userSpaceOnUse">
            ...
            <filter id="displacement-filter-linear2" x="-20%" y="-20%" width="140%" height="140%" colorInterpolationFilters="sRGB" preserveAspectRatio="none">
            ...
            <rect fill="url(#rainbowgradientLinear2)" width="200%" height="200%" x="-50%" y="-50%" 
              style={{
                opacity: 0.6,
                transform: 'rotateX(-45deg)',
                filter: 'url(#displacement-filter-linear2)'
              }}
            />
